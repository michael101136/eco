...
<!-- /new_arrivals --> 
  <div class="new_arrivals_agile_w3ls_info"> 
    <div class="container">
        <h3 class="wthree_text_info">CATEGORIA <span>DE PRODUCTO</span></h3>   
        ...
        @foreach($categoria as $item)
          ...
          <div class="resp-tabs-container">
                <!--/tab_one-->
                 ...
                 @foreach($toursPorCategoria as $key => $value)
                    <div class="tab{{$value['id']}}">

                         @foreach($value['tour'] as $key => $values)
                                <div class="col-md-3 product-men">
                                  <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item">
                                      <img src="{{$values->img}}" alt="" class="pro-image-front">
                                      <img src="{{$values->img}}" alt="" class="pro-image-back">
                                        <div class="men-cart-pro">
                                          <div class="inner-men-cart-pro">
                                            <a href="{{$values->slug}}" class="link-product-add-cart">Ver</a>
                                          </div>
                                        </div>
                                        <span class="product-new-top"> {{$values->nameSub}} </span>

                                        
                                    </div>
                                    <div class="item-info-product ">
                                      <h4><a href="{{$values->slug}}">{{$values->nametour}} </a></h4>
                                      <div class="info-product-price">
                                        <span class="item_price">{{$values->price}}</span>
                                        <del>$69.71</del>
                                      </div>
                  ...
                  <div class="tab5">
                    ...
                    <div class="tab6">
                      ...
                      <div class="men-pro-item simpleCart_shelfItem">
                        ...
                        <div class="item-info-product ">
                          <h4><a href="single.html">Women BLACK Heels michael</a></h4>
                          <div class="info-product-price">
                            <span class="item_price">$180.99</span>
                            <del>$199.71</del>
                          </div>
